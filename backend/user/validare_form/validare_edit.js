...
document.addEventListener("DOMContentLoaded", function () {
  ...
  form_password.addEventListener("submit", function (event) {
    ...
    const password = form_password.querySelector(
      "input[name='password']"
    ).value;
    const new_password = form_password.querySelector(
    ...
    fetch("/edit_password", {
      ...
      .then((response) => {
        ...
        return response
          .json()
          .then((data_password) => ({ status, data_password }));
      })
